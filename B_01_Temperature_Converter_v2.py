...
class Converter:
    ...
    def convert(self, min_temp, to_convert):
        """
        Converts temperature and updates answer label. Also stores calculations for
...
class HistoryExport:
    ...
    def __init__(self, partner, calculations):
        ...
        # Last item added in outside the for loop os that the spacing is correct
        ...
        # config it to show the filename if the user exports the file
    ...
    def export_data(self,calculations):
        ...
        print("in write area: ", calculations)
